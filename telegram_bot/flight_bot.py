...
This bot focuses on extracting and analyzing individual flights.
For callsign tracking, use the Callsign bot instead.
...
class FlightExtractionBot:
    ...
    async def cmd_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            ...
            "/help - Show help\n\n"
            "Example: /extract DAL123 2024-12-31"
        )
    ...
    def run(self):
        ...
        log.info("Starting Flight Extraction Bot...")
